...
class wellthemes_pinterest_widget extends WP_Widget {
	...
	function widget($args, $instance){
		...
		if ( $title ){ ?>
			<div class="widget-title">
				<div class="icon"><i class="icon-pinterest"></i></div>
	...
	function form($instance){
		$instance = wp_parse_args( (array) $instance, array( 'title' => 'Recent Pins', 'username' => '', 'number_of_pins' => '9', 'show_follow_button' => '0', 'specific_board' => '') );
