 ...
 */
add_action( 'widgets_init', 'wellthemes_top_reviews_text_widgets' );

function wellthemes_top_reviews_text_widgets() {
	register_widget( 'wellthemes_top_reviews_text_widget' );
}
 ...
 *
 */
class wellthemes_top_reviews_text_widget extends WP_Widget {

	/**
	 * Widget setup.
	 */
	function wellthemes_top_reviews_text_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget_reviews_text', 'description' => __('Displays the most top reviews with numbers.', 'wellthemes') );

		/* Create the widget. */
		$this->WP_Widget( 'wellthemes_top_reviews_text_widget', __('Well Themes: Top Reviews Text', 'wellthemes'), $widget_ops);
	}
