...
function wt_custom_styles(){
	...
	$wt_bg_color = $options['wt_bg_color'];
	$wt_bg_pattern = $options['wt_bg_pattern'];
	$wt_bg_img = $options['wt_bg_img'];
	$wt_bg_repeat = $options['wt_bg_repeat'];
	...
	if (
		...
		if (!empty($wt_bg_color) ){
			$wt_custom_style .= "	background-color: " .$wt_bg_color. ";\n";
		}
		
		if (!empty($wt_bg_pattern) ){
			$wt_custom_style .= " background: url(".get_template_directory_uri()."/images/bg/original/pattern".$wt_bg_pattern.".png) repeat;\n";
		}
		
		if (!empty($wt_bg_img) ){
			$wt_custom_style .= "	background-image: url(" .$wt_bg_img. ");\n";
		
			if (!empty($wt_bg_repeat) ){
			
				if ($wt_bg_repeat == "cover"){
						...
						$wt_custom_style .= "	background-repeat: " .$wt_bg_repeat. ";\n";
				}
			}		
		}
	...
	$wt_menu_item1_color = $options['wt_menu_item1_color'];
	$wt_menu_item2_color = $options['wt_menu_item2_color'];
	$wt_menu_item3_color = $options['wt_menu_item3_color'];
	$wt_menu_item4_color = $options['wt_menu_item4_color'];
	$wt_menu_item5_color = $options['wt_menu_item5_color'];	
	
	if (!empty($wt_menu_item1_color)){
		$wt_custom_style .= "#header .links .item1{\n    background: ".$wt_menu_item1_color.";\n}\n\n";	
	}
	
	if (!empty($wt_menu_item2_color)){
		$wt_custom_style .= "#header .links .item2{\n    background: ".$wt_menu_item2_color.";\n}\n\n";	
	}
	
	if (!empty($wt_menu_item3_color)){
		$wt_custom_style .= "#header .links .item3{\n    background: ".$wt_menu_item3_color.";\n}\n\n";	
	}
	
	if (!empty($wt_menu_item4_color)){
		$wt_custom_style .= "#header .links .item4{\n    background: ".$wt_menu_item4_color.";\n}\n\n";	
	}
	
	if (!empty($wt_menu_item5_color)){
		$wt_custom_style .= "#header .links .item5{\n    background: ".$wt_menu_item5_color.";\n}\n\n";	
	}
	...
	if (!empty($wt_primary_color)){
		...
		$wt_custom_style .= ".menu-section .search .button{ \n    border-bottom: 1px solid ".$wt_primary_color." \n}\n\n";
		$wt_custom_style .= ".post-nav{ \n    border-bottom: 3px solid ".$wt_primary_color." \n}\n\n";
	...
	if (!empty($wt_second_color)){
		...
		$wt_custom_style .= ".tab-titles .active i,\n .col-header hr,\n .widget .flex-control-nav a.flex-active{ \n    color: ".$wt_second_color." \n}\n\n";
		$wt_custom_style .= ".col-header hr,\n #main-menu .current-menu-item,\n #main-menu .current_page_item,\n #main-menu ul li a:hover{ \n    background: ".$wt_second_color." \n}\n\n";
		$wt_custom_style .= "#footer{ \n    border-top: 5px solid ".$wt_second_color." \n}\n\n";
