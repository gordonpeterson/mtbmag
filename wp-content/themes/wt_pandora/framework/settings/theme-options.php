			...
			<div class="header">	
				<div class="main">
					...
					<div class="theme-info">		
						<h3><?php _e('Pandora Theme', 'wellthemes'); ?></h3>			
						<ul>
							<li class="support">
								<i class="icon-flag"></i>
		...
		<div class="options-wrap">
			...
			<div class="tabs">
				<ul>
					...
					<li class="hmenu"><a href="#hmenu"><i class="icon-reorder"></i><?php echo _e('Header Menu', 'wellthemes'); ?></a></li>
					<li class="posts"><a href="#posts"><i class="icon-file-text"></i><?php echo _e('Posts and Archives', 'wellthemes'); ?></a></li>
			...
			<div class="options-form">			
					...
					<form action="options.php" method="post">
						...
						<div class="tab_content">
							...
							<div id="hmenu" class="tab_block">
								<h2><?php _e('Header Menu Settings', 'wellthemes'); ?></h2>
								<div class="fields_wrap">
									<div class="field infobox">
										<p><strong><?php _e('Header Menu', 'wellthemes'); ?></strong></p>
										<?php _e('You can configure the header menu on this page. You can use background image, icon with background color or only background oclor for each item.', 'wellthemes'); ?>
									</div>							
									
									<div class="field">
										<label for="wt_options[wt_hide_header_menu]"><?php _e('Disable Menu', 'wellthemes'); ?></label>
										<input id="wt_options[wt_hide_header_menu]" name="wt_options[wt_hide_header_menu]" type="checkbox" value="1" <?php isset($options['wt_hide_header_menu']) ? checked( '1', $options['wt_hide_header_menu'] ) : checked('0', '1'); ?> />
										<span class="description chkdesc"><?php _e( 'Check if you want to disable post header menu.', 'wellthemes' ); ?></span>					
									</div>
									
									
									<h4><?php _e('Menu item 1', 'wellthemes'); ?></h4>
									
									<div class="field">
										<label for="wt_options[wt_menu_item1_title]"><?php _e('Item Title', 'wellthemes'); ?></label>
										<input id="wt_options[wt_menu_item1_title]" name="wt_options[wt_menu_item1_title]" type="text" value="<?php echo esc_attr($options['wt_menu_item1_title']); ?>" />
										<span class="description long"><?php _e( 'Enter the item title', 'wellthemes' ); ?></span>
									</div>
									
									<div class="field">
										<label for="wt_options[wt_menu_item1_url]"><?php _e('Item Link', 'wellthemes'); ?></label>
										<input id="wt_options[wt_menu_item1_url]" name="wt_options[wt_menu_item1_url]" type="text" value="<?php echo esc_attr($options['wt_menu_item1_url']); ?>" />
										<span class="description long"><?php _e( 'Enter full URL starting with <strong>http:// </strong>. Leave blank to disable the item.', 'wellthemes' ); ?></span>
									</div>
									
									<div class="field">
										<label><?php _e('Item Background color', 'wellthemes'); ?></label>
										<div id="wt_menu_item1_color_selector" class="color-pic"><div style="background-color:<?php echo $options['wt_menu_item1_color'] ; ?>"></div></div>
										<input style="width:80px; margin-right:5px;"  name="wt_options[wt_menu_item1_color]" id="wt_menu_item1_color" type="text" value="<?php echo $options['wt_menu_item1_color'] ; ?>" />
										<span class="description chkdesc"><?php _e( 'Select background color for the item.', 'wellthemes' ); ?></span>
									</div>									
									
									<div class="field">
										<label for="wt_options[wt_menu_item1_icon]"><?php _e('Item Icon', 'wellthemes'); ?></label>
										<input id="wt_options[wt_menu_item1_icon]" name="wt_options[wt_menu_item1_icon]" type="text" value="<?php echo esc_attr($options['wt_menu_item1_icon']); ?>" />
										<span class="description long"><?php _e( 'Enter the icon name only. Check theme documentation for list of icon names.', 'wellthemes' ); ?></span>
									</div>
									
									<div class="field field-upload">
										<label for="wt_menu_item1_img"><?php _e('Item Image', 'wellthemes'); ?></label>
										<input id="wt_options[wt_menu_item1_img]" class="upload_image" type="text" name="wt_options[wt_menu_item1_img]" value="<?php echo esc_attr($options['wt_menu_item1_img']); ?>" />
                                        
										<input class="upload_image_button" id="wt_menu_item1_img_button" type="button" value="Upload" />
										<span class="description long updesc"><?php _e('Upload 110x110px image. Leave blank to use background color or image.', 'wellthemes'); ?>
										</span> 
									</div> 
									
									<h4><?php _e('Menu item 2', 'wellthemes'); ?></h4>
									
									<div class="field">
										<label for="wt_options[wt_menu_item2_title]"><?php _e('Item Title', 'wellthemes'); ?></label>
										<input id="wt_options[wt_menu_item2_title]" name="wt_options[wt_menu_item2_title]" type="text" value="<?php echo esc_attr($options['wt_menu_item2_title']); ?>" />
										<span class="description long"><?php _e( 'Enter the item title', 'wellthemes' ); ?></span>
									</div>
									
									<div class="field">
										<label for="wt_options[wt_menu_item2_url]"><?php _e('Item Link', 'wellthemes'); ?></label>
										<input id="wt_options[wt_menu_item2_url]" name="wt_options[wt_menu_item2_url]" type="text" value="<?php echo esc_attr($options['wt_menu_item2_url']); ?>" />
										<span class="description long"><?php _e( 'Enter full URL starting with <strong>http:// </strong>. Leave blank to disable the item.', 'wellthemes' ); ?></span>
									</div>
									
									<div class="field">
										<label><?php _e('Item Background color', 'wellthemes'); ?></label>
										<div id="wt_menu_item2_color_selector" class="color-pic"><div style="background-color:<?php echo $options['wt_menu_item2_color'] ; ?>"></div></div>
										<input style="width:80px; margin-right:5px;"  name="wt_options[wt_menu_item2_color]" id="wt_menu_item2_color" type="text" value="<?php echo $options['wt_menu_item2_color'] ; ?>" />
										<span class="description chkdesc"><?php _e( 'Select background color for the item.', 'wellthemes' ); ?></span>
									</div>									
									
									<div class="field">
										<label for="wt_options[wt_menu_item2_icon]"><?php _e('Item Icon', 'wellthemes'); ?></label>
										<input id="wt_options[wt_menu_item2_icon]" name="wt_options[wt_menu_item2_icon]" type="text" value="<?php echo esc_attr($options['wt_menu_item2_icon']); ?>" />
										<span class="description long"><?php _e( 'Enter the icon name only. Check theme documentation for list of icon names.', 'wellthemes' ); ?></span>
									</div>
									
									<div class="field field-upload">
										<label for="wt_menu_item2_img"><?php _e('Item Image', 'wellthemes'); ?></label>
										<input id="wt_options[wt_menu_item2_img]" class="upload_image" type="text" name="wt_options[wt_menu_item2_img]" value="<?php echo esc_attr($options['wt_menu_item2_img']); ?>" />
                                        
										<input class="upload_image_button" id="wt_menu_item2_img_button" type="button" value="Upload" />
										<span class="description long updesc"><?php _e('Upload 110x110px image. Leave blank to use background color or image.', 'wellthemes'); ?>
										</span> 
									</div> 
									
									<h4><?php _e('Menu item 3', 'wellthemes'); ?></h4>
									
									<div class="field">
										<label for="wt_options[wt_menu_item3_title]"><?php _e('Item Title', 'wellthemes'); ?></label>
										<input id="wt_options[wt_menu_item3_title]" name="wt_options[wt_menu_item3_title]" type="text" value="<?php echo esc_attr($options['wt_menu_item3_title']); ?>" />
										<span class="description long"><?php _e( 'Enter the item title', 'wellthemes' ); ?></span>
									</div>
									
									<div class="field">
										<label for="wt_options[wt_menu_item3_url]"><?php _e('Item Link', 'wellthemes'); ?></label>
										<input id="wt_options[wt_menu_item3_url]" name="wt_options[wt_menu_item3_url]" type="text" value="<?php echo esc_attr($options['wt_menu_item3_url']); ?>" />
										<span class="description long"><?php _e( 'Enter full URL starting with <strong>http:// </strong>. Leave blank to disable the item.', 'wellthemes' ); ?></span>
									</div>
									
									<div class="field">
										<label><?php _e('Item Background color', 'wellthemes'); ?></label>
										<div id="wt_menu_item3_color_selector" class="color-pic"><div style="background-color:<?php echo $options['wt_menu_item3_color'] ; ?>"></div></div>
										<input style="width:80px; margin-right:5px;"  name="wt_options[wt_menu_item3_color]" id="wt_menu_item3_color" type="text" value="<?php echo $options['wt_menu_item3_color'] ; ?>" />
										<span class="description chkdesc"><?php _e( 'Select background color for the item.', 'wellthemes' ); ?></span>
									</div>									
									
									<div class="field">
										<label for="wt_options[wt_menu_item3_icon]"><?php _e('Item Icon', 'wellthemes'); ?></label>
										<input id="wt_options[wt_menu_item3_icon]" name="wt_options[wt_menu_item3_icon]" type="text" value="<?php echo esc_attr($options['wt_menu_item3_icon']); ?>" />
										<span class="description long"><?php _e( 'Enter the icon name only. Check theme documentation for list of icon names.', 'wellthemes' ); ?></span>
									</div>
									
									<div class="field field-upload">
										<label for="wt_menu_item3_img"><?php _e('Item Image', 'wellthemes'); ?></label>
										<input id="wt_options[wt_menu_item3_img]" class="upload_image" type="text" name="wt_options[wt_menu_item3_img]" value="<?php echo esc_attr($options['wt_menu_item3_img']); ?>" />
                                        
										<input class="upload_image_button" id="wt_menu_item3_img_button" type="button" value="Upload" />
										<span class="description long updesc"><?php _e('Upload 110x110px image. Leave blank to use background color or image.', 'wellthemes'); ?>
										</span> 
									</div> 
									
									<h4><?php _e('Menu item 4', 'wellthemes'); ?></h4>
									
									<div class="field">
										<label for="wt_options[wt_menu_item4_title]"><?php _e('Item Title', 'wellthemes'); ?></label>
										<input id="wt_options[wt_menu_item4_title]" name="wt_options[wt_menu_item4_title]" type="text" value="<?php echo esc_attr($options['wt_menu_item4_title']); ?>" />
										<span class="description long"><?php _e( 'Enter the item title', 'wellthemes' ); ?></span>
									</div>
									
									<div class="field">
										<label for="wt_options[wt_menu_item4_url]"><?php _e('Item Link', 'wellthemes'); ?></label>
										<input id="wt_options[wt_menu_item4_url]" name="wt_options[wt_menu_item4_url]" type="text" value="<?php echo esc_attr($options['wt_menu_item4_url']); ?>" />
										<span class="description long"><?php _e( 'Enter full URL starting with <strong>http:// </strong>. Leave blank to disable the item.', 'wellthemes' ); ?></span>
									</div>
									
									<div class="field">
										<label><?php _e('Item Background color', 'wellthemes'); ?></label>
										<div id="wt_menu_item4_color_selector" class="color-pic"><div style="background-color:<?php echo $options['wt_menu_item4_color'] ; ?>"></div></div>
										<input style="width:80px; margin-right:5px;"  name="wt_options[wt_menu_item4_color]" id="wt_menu_item4_color" type="text" value="<?php echo $options['wt_menu_item4_color'] ; ?>" />
										<span class="description chkdesc"><?php _e( 'Select background color for the item.', 'wellthemes' ); ?></span>
									</div>									
									
									<div class="field">
										<label for="wt_options[wt_menu_item4_icon]"><?php _e('Item Icon', 'wellthemes'); ?></label>
										<input id="wt_options[wt_menu_item4_icon]" name="wt_options[wt_menu_item4_icon]" type="text" value="<?php echo esc_attr($options['wt_menu_item4_icon']); ?>" />
										<span class="description long"><?php _e( 'Enter the icon name only. Check theme documentation for list of icon names.', 'wellthemes' ); ?></span>
									</div>
									
									<div class="field field-upload">
										<label for="wt_menu_item4_img"><?php _e('Item Image', 'wellthemes'); ?></label>
										<input id="wt_options[wt_menu_item4_img]" class="upload_image" type="text" name="wt_options[wt_menu_item4_img]" value="<?php echo esc_attr($options['wt_menu_item4_img']); ?>" />
                                        
										<input class="upload_image_button" id="wt_menu_item4_img_button" type="button" value="Upload" />
										<span class="description long updesc"><?php _e('Upload 110x110px image. Leave blank to use background color or image.', 'wellthemes'); ?>
										</span> 
									</div> 
									
									<h4><?php _e('Menu item 5', 'wellthemes'); ?></h4>
									
									<div class="field">
										<label for="wt_options[wt_menu_item5_title]"><?php _e('Item Title', 'wellthemes'); ?></label>
										<input id="wt_options[wt_menu_item5_title]" name="wt_options[wt_menu_item5_title]" type="text" value="<?php echo esc_attr($options['wt_menu_item5_title']); ?>" />
										<span class="description long"><?php _e( 'Enter the item title', 'wellthemes' ); ?></span>
									</div>
									
									<div class="field">
										<label for="wt_options[wt_menu_item5_url]"><?php _e('Item Link', 'wellthemes'); ?></label>
										<input id="wt_options[wt_menu_item5_url]" name="wt_options[wt_menu_item5_url]" type="text" value="<?php echo esc_attr($options['wt_menu_item5_url']); ?>" />
										<span class="description long"><?php _e( 'Enter full URL starting with <strong>http:// </strong>. Leave blank to disable the item.', 'wellthemes' ); ?></span>
									</div>
									
									<div class="field">
										<label><?php _e('Item Background color', 'wellthemes'); ?></label>
										<div id="wt_menu_item5_color_selector" class="color-pic"><div style="background-color:<?php echo $options['wt_menu_item5_color'] ; ?>"></div></div>
										<input style="width:80px; margin-right:5px;"  name="wt_options[wt_menu_item5_color]" id="wt_menu_item5_color" type="text" value="<?php echo $options['wt_menu_item5_color'] ; ?>" />
										<span class="description chkdesc"><?php _e( 'Select background color for the item.', 'wellthemes' ); ?></span>
									</div>									
									
									<div class="field">
										<label for="wt_options[wt_menu_item5_icon]"><?php _e('Item Icon', 'wellthemes'); ?></label>
										<input id="wt_options[wt_menu_item5_icon]" name="wt_options[wt_menu_item5_icon]" type="text" value="<?php echo esc_attr($options['wt_menu_item5_icon']); ?>" />
										<span class="description long"><?php _e( 'Enter the icon name only. Check theme documentation for list of icon names.', 'wellthemes' ); ?></span>
									</div>
									
									<div class="field field-upload">
										<label for="wt_menu_item5_img"><?php _e('Item Image', 'wellthemes'); ?></label>
										<input id="wt_options[wt_menu_item5_img]" class="upload_image" type="text" name="wt_options[wt_menu_item5_img]" value="<?php echo esc_attr($options['wt_menu_item5_img']); ?>" />
                                        
										<input class="upload_image_button" id="wt_menu_item5_img_button" type="button" value="Upload" />
										<span class="description long updesc"><?php _e('Upload 110x110px image. Leave blank to use background color or image.', 'wellthemes'); ?>
										</span> 
									</div> 
								...
								<h2><?php _e('Sidebars', 'wellthemes'); ?></h2>
									<div class="fields_wrap">
										...
										<div class="field">
											...
											<span class="description slcdesc"><?php _e( 'Select sidebar for the homepage.', 'wellthemes' ); ?></span>
										</div><!-- /field -->										
										...
										<div class="field">
											...
											<span class="description slcdesc"><?php _e( 'Select sidebar for the single post.', 'wellthemes' ); ?></span>
										</div><!-- /field -->
										...
										<div class="field">
											...
											<span class="description slcdesc"><?php _e( 'Select sidebar for the single page.', 'wellthemes' ); ?></span>
										</div><!-- /field -->
										...
										<div class="field">
											...
											<span class="description slcdesc"><?php _e( 'Select sidebar for the category archives page.', 'wellthemes' ); ?></span>
										</div><!-- /field -->
										...
										<div class="field">
											...
											<span class="description slcdesc"><?php _e( 'Select sidebar for the archives page.', 'wellthemes' ); ?></span>
										</div><!-- /field -->
							...
							<div id="styles" class="tab_block">
								...
								<div class="fields_wrap">
									...
									<div class="field infobox">
										...
										<?php _e('You can select the background and the theme color schemes. The background you select here will be used on all theme. You can specify a post or page background from the post settings.', 'wellthemes'); ?>
									</div>																	
									...
									<h3><?php _e('Use Background Pattern', 'wellthemes'); ?></h3>									
									<div class="field">
									...
									<div class="field">										
										<label for="wt_bg_img">Background Image</label>
										<input id="wt_options[wt_bg_img]" class="upload_image" type="text" name="wt_options[wt_bg_img]" value="<?php echo esc_attr($options['wt_bg_img']); ?>" />
									...
									<div class="meta-field">
										...
										<select id="wt_bg_repeat" name="wt_options[wt_bg_repeat]" class="styled">
											<option value="repeat" <?php selected( $options['wt_bg_repeat'] == 'repeat');?>>Repeat</option>	
											<option value="repeat-x" <?php selected( $options['wt_bg_repeat'] == 'repeat-x');?>>Repeat x</option>	
											<option value="repeat-y" <?php selected( $options['wt_bg_repeat'] == 'repeat-y');?>>Repeat y</option>	
											<option value="no-repeat" <?php selected( $options['wt_bg_repeat'] == 'no-repeat');?>>No Repeat</option>	
											<option value="cover" <?php selected( $options['wt_bg_repeat'] == 'cover');?>>Cover</option>
										</select>
							...
							<div id="contact" class="tab_block">
								<h2><?php _e('Contact Settings', 'wellthemes'); ?></h2>
									<div class="fields_wrap">
										...
										<div class="field">
											<label for="wt_options[wt_show_contact_map]"><?php _e('Show map', 'wellthemes'); ?></label>
											<input id="wt_options[wt_show_contact_map]" name="wt_options[wt_show_contact_map]" type="checkbox" value="1" <?php isset($options['wt_show_contact_map']) ? checked( '1', $options['wt_show_contact_map'] ) : checked('0', '1'); ?> />
											<span class="description chkdesc"><?php _e( 'Check to show the map on contact page.', 'wellthemes' ); ?></span>					
										</div>	
									
										<h3><?php _e('Contact Form Settings', 'wellthemes'); ?></h3>
										...
										<h3><?php _e('Contact Information', 'wellthemes'); ?></h3>
										<div class="field">
											<label for="wt_options[wt_contact_phone]"><?php _e('Phone number', 'wellthemes'); ?></label>
											<input id="wt_options[wt_contact_phone]" name="wt_options[wt_contact_phone]" type="text" value="<?php echo esc_attr($options['wt_contact_phone']); ?>" />
											<span class="description long"><?php _e( 'Enter the phone number do display on contact page.', 'wellthemes' ); ?></span>
										</div>
										
										<div class="field">
											<label for="wt_options[wt_contact_visible_email]"><?php _e('Email', 'wellthemes'); ?></label>
											<input id="wt_options[wt_contact_visible_email]" name="wt_options[wt_contact_visible_email]" type="text" value="<?php echo esc_attr($options['wt_contact_visible_email']); ?>" />
											<span class="description long"><?php _e( 'Enter your email. Please note this will be visible on the contact page.', 'wellthemes' ); ?></span>
										</div>
										
										<h3><?php _e('Social Links', 'wellthemes'); ?></h3>
										
										<div class="field">
											<label for="wt_options[wt_contact_show_social]"><?php _e('Show Social Links', 'wellthemes'); ?></label>
											<input id="wt_options[wt_contact_show_social]" name="wt_options[wt_contact_show_social]" type="checkbox" value="1" <?php isset($options['wt_contact_show_social']) ? checked( '1', $options['wt_contact_show_social'] ) : checked('0', '1'); ?> />
											<span class="description chkdesc"><?php _e( 'Check to enable social media links on contact page.', 'wellthemes' ); ?></span>					
										</div>
										...
										<div class="field">
											...
											<span class="description long"><?php _e( 'Enter full URL of your Google+ Profile.', 'wellthemes' ); ?></span>
										</div>
										...
										<div class="field">
											...
											<span class="description long"><?php _e( 'Enter full URL of your Facebook Profile.', 'wellthemes' ); ?></span>
										</div>
										...
										<div class="field">
											...
											<span class="description long"><?php _e( 'Enter full URL of your Twitter Profile.', 'wellthemes' ); ?></span>
										</div>
										
										<div class="field">
											<label for="wt_options[wt_linkedin_url]"><?php _e('Linkedin URL', 'wellthemes'); ?></label>
											<input id="wt_options[wt_linkedin_url]" name="wt_options[wt_linkedin_url]" type="text" value="<?php echo esc_attr($options['wt_linkedin_url']); ?>" />
											<span class="description long"><?php _e( 'Enter full URL of your Linkedin profile.', 'wellthemes' ); ?></span>
										</div>										
										
										<div class="field">
											<label for="wt_options[wt_dribbble_url]"><?php _e('Dribbble URL', 'wellthemes'); ?></label>
											...
											<span class="description long"><?php _e( 'Enter full URL of your Dribbble profile.', 'wellthemes' ); ?></span>
										</div>
										
										<div class="field">
											<label for="wt_options[wt_pinterest_url]"><?php _e('Pinterest URL', 'wellthemes'); ?></label>
											...
											<span class="description long"><?php _e( 'Enter full URL of your Pinterest profile.', 'wellthemes' ); ?></span>
										</div>
										...
										<div class="field">
											...
											<span class="description long"><?php _e( 'Enter full URL of your Instagram profile.', 'wellthemes' ); ?></span>
										</div>
										...
										<div class="field">
											...
											<span class="description long"><?php _e( 'Enter full URL of your Youtube profile.', 'wellthemes' ); ?></span>
										</div>
																				
										<h3><?php _e('About us section', 'wellthemes'); ?></h3>
										
										<div class="field">
											<label for="wt_contact_logo"><?php _e('Contact Page Logo', 'wellthemes'); ?></label>
											<input id="wt_options[wt_contact_logo]" class="upload_image" type="text" name="wt_options[wt_contact_logo]" value="<?php echo esc_attr($options['wt_contact_logo']); ?>" />
											<input class="upload_image_button" id="wt_contact_logo_button" type="button" value="Upload" />
											<span class="description updesc"><?php _e('Upload logo for contact page. Leave blank to use default logo', 'wellthemes'); ?></span> 
										</div>
																			
										<div class="field">
											<label for="wt_options[wt_contact_text]"><?php _e('Who we are.', 'wellthemes'); ?></label>
											<textarea id="wt_options[wt_contact_text]" class="textarea" name="wt_options[wt_contact_text]"><?php echo esc_attr($options['wt_contact_text']); ?></textarea>
											<span class="description"><?php _e( 'Enter the text for the contact page.', 'wellthemes' ); ?></span>					
										</div>	
...
function wt_default_options() {
	$options = array(
		...
		'wt_menu_item1_title' => 'Home',	
		'wt_menu_item2_title' => '',	
		'wt_menu_item3_title' => '',	
		'wt_menu_item4_title' => '',	
		'wt_menu_item5_title' => '',		
		'wt_menu_item1_url' => get_site_url(),
		'wt_menu_item2_url' => get_site_url(),
		'wt_menu_item3_url' => get_site_url(),
		'wt_menu_item4_url' => get_site_url(),
		'wt_menu_item5_url' => get_site_url(),		
		'wt_menu_item1_color' => '',
		'wt_menu_item2_color' => '',
		'wt_menu_item3_color' => '',
		'wt_menu_item4_color' => '',
		'wt_menu_item5_color' => '',		
		'wt_menu_item1_icon' => 'icon-home',
		'wt_menu_item2_icon' => '',
		'wt_menu_item3_icon' => '',
		'wt_menu_item4_icon' => '',
		'wt_menu_item5_icon' => '',		
		...
		'wt_hide_post_nav' => 0,
		'wt_hide_header_menu' => 0,		
		'wt_hide_post_img' => 0,
		'wt_hide_post_meta' => 0,		
		'wt_hide_post_social' => 0,			
		'wt_hide_page_author_info' => 1,		
		'wt_hide_page_meta' => 1,	
		'wt_hide_page_social' => 1,
		'wt_hide_img_meta' => 0,
		...
		'wt_contact_address' => '',
		'wt_contact_email' => '',	
		'wt_contact_visible_email' => '',		
		'wt_recaptcha_public_key' => '',
		'wt_recaptcha_private_key' => '',		
		'wt_contact_subject' => '',	
		'wt_contact_text' => '',
		'wt_contact_phone' => '',	
		'wt_contact_show_social' => 1,		
		'wt_gplus_url' => '',
		'wt_fb_url' => '',
		'wt_twitter_url' => '',
		'wt_linkedin_url' => '',
		...
		'wt_instagram_url' => '',
		'wt_youtube_url' => '',
		'wt_contact_logo' => get_template_directory_uri().'/images/logo.png',		
...
function wt_validate_options( $input ) {
	...
	if( $submit ) :	
		...
		$input['wt_contact_phone'] = wp_kses_stripslashes($input['wt_contact_phone']);
		$input['wt_contact_visible_email'] = wp_filter_nohtml_kses($input['wt_contact_visible_email']);
		...
		$input['wt_linkedin_url'] = esc_url_raw($input['wt_linkedin_url']);
		...
		$input['wt_contact_logo'] = esc_url_raw($input['wt_contact_logo']);
		
		$input['wt_menu_item1_title'] = wp_kses_stripslashes($input['wt_menu_item1_title']);
		$input['wt_menu_item2_title'] = wp_kses_stripslashes($input['wt_menu_item2_title']);
		$input['wt_menu_item3_title'] = wp_kses_stripslashes($input['wt_menu_item3_title']);
		$input['wt_menu_item4_title'] = wp_kses_stripslashes($input['wt_menu_item4_title']);
		$input['wt_menu_item5_title'] = wp_kses_stripslashes($input['wt_menu_item5_title']);
		$input['wt_menu_item1_url'] = esc_url_raw($input['wt_menu_item1_url']);
		$input['wt_menu_item2_url'] = esc_url_raw($input['wt_menu_item2_url']);
		$input['wt_menu_item3_url'] = esc_url_raw($input['wt_menu_item3_url']);
		$input['wt_menu_item4_url'] = esc_url_raw($input['wt_menu_item4_url']);
		$input['wt_menu_item5_url'] = esc_url_raw($input['wt_menu_item5_url']);		
		$input['wt_menu_item1_color'] = wp_filter_nohtml_kses($input['wt_menu_item1_color']);	
		$input['wt_menu_item2_color'] = wp_filter_nohtml_kses($input['wt_menu_item2_color']);
		$input['wt_menu_item3_color'] = wp_filter_nohtml_kses($input['wt_menu_item3_color']);
		$input['wt_menu_item4_color'] = wp_filter_nohtml_kses($input['wt_menu_item4_color']);
		$input['wt_menu_item5_color'] = wp_filter_nohtml_kses($input['wt_menu_item5_color']);		
		$input['wt_menu_item1_icon'] = wp_filter_nohtml_kses($input['wt_menu_item1_icon']);
		$input['wt_menu_item2_icon'] = wp_filter_nohtml_kses($input['wt_menu_item2_icon']);
		$input['wt_menu_item3_icon'] = wp_filter_nohtml_kses($input['wt_menu_item3_icon']);
		$input['wt_menu_item4_icon'] = wp_filter_nohtml_kses($input['wt_menu_item4_icon']);
		$input['wt_menu_item5_icon'] = wp_filter_nohtml_kses($input['wt_menu_item5_icon']);		
		$input['wt_menu_item1_img'] = esc_url_raw($input['wt_menu_item1_img']);
		$input['wt_menu_item2_img'] = esc_url_raw($input['wt_menu_item2_img']);
		$input['wt_menu_item3_img'] = esc_url_raw($input['wt_menu_item3_img']);
		$input['wt_menu_item4_img'] = esc_url_raw($input['wt_menu_item4_img']);
		$input['wt_menu_item5_img'] = esc_url_raw($input['wt_menu_item5_img']);
		$input['wt_bg_color'] = wp_filter_nohtml_kses($input['wt_bg_color']);
		$input['wt_bg_img'] = esc_url_raw($input['wt_bg_img']);
		$input['wt_bg_pattern'] = wp_filter_nohtml_kses($input['wt_bg_pattern']);		
		...
		if ( ! isset( $input['wt_hide_header_menu'] ) )
			$input['wt_hide_header_menu'] = null;
		$input['wt_hide_header_menu'] = ( $input['wt_hide_header_menu'] == 1 ? 1 : 0 );
		...
		if ( ! isset( $input['wt_show_contact_map'] ) )
			$input['wt_show_contact_map'] = null;
		$input['wt_show_contact_map'] = ( $input['wt_show_contact_map'] == 1 ? 1 : 0 );			
		
		if ( ! isset( $input['wt_contact_show_social'] ) )
			$input['wt_contact_show_social'] = null;
		$input['wt_contact_show_social'] = ( $input['wt_contact_show_social'] == 1 ? 1 : 0 );		
