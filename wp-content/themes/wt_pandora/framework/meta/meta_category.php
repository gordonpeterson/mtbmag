...
function wt_category_meta_add_field( $cat ) {	
		...
		if( isset($cat->term_id) ){
			...
			$saved_icon = $wt_category_meta['wt_cat_meta_icon'];	
		...
		<table class="form-table">
			...
			<tbody>
				...
				<tr class="form-field">
					<th scope="row" valign="top"><label for="wt_cat_meta_icon"><?php _e( 'Category Icon', 'wellthemes' ); ?></label></th>			
					<td>
						<input name="wt_category_meta[wt_cat_meta_icon]" id="wt_cat_meta_icon" type="text" value="<?php echo $saved_icon; ?>" />
						<p class="description"><?php _e( 'Enter color name. Check theme documentation for complete list of icons.', 'wellthemes'); ?></p></td>
				</tr>
