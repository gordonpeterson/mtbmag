	...
	<?php if (have_posts()) :?>
		...
		<div class="archive-columns">
			...
			<div class="row">
				...
				<div class="col one-half">
					<div class="col-header">
						<h3><?php _e('Last 10 Posts:', 'wellthemes')?></h3><hr />
					</div>
				...
				<div class="col one-half last">
					<div class="col-header">
						<h3><?php _e('Most Popular Tags:', 'wellthemes')?></h3><hr />
					</div>
			...
			<div class="row">
				...
				<div class="col one-half">
					<div class="col-header">
						<h3><?php _e('Archives by Category:', 'wellthemes')?></h3><hr />
					</div>
				...
				<div class="col one-half last">
					<div class="col-header">
					<h3><?php _e('Archives By Month:', 'wellthemes')?></h3><hr />
				</div>
			...
			<div class="row">
				<div class="col one-half">
					<div class="col-header">
						<h3><?php _e('Pages:', 'wellthemes')?></h3><hr />
					</div>
				...
				<div class="col one-half last">
					<div class="col-header">
						<h3><?php _e('Search Archives:', 'wellthemes')?></h3><hr />
					</div>
