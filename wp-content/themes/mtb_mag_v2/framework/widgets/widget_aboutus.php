	   ...
	   <div class="social-links">
		   <ul class="list">
			   <?php if(!empty($twitter_url)){	?>
					<li>						
						<a class="twitter" href="<?php echo $twitter_url; ?>" target="_blank"><?php _e('Twitter', 'wellthemes'); ?></a>
					</li>
				<?php
				} 
				...
				if(!empty($facebook_url)){	?>
					<li>
						<a class="fb" href="<?php echo $facebook_url; ?>" target="_blank"><?php _e('Facebook', 'wellthemes'); ?></a>
					</li>
				<?php }
				
				if(!empty($gplus_url)){	?>
					<li>
						<a class="gplus" href="<?php echo $gplus_url; ?>" target="_blank"><?php _e('Google+', 'wellthemes'); ?></a>
					</li>
				<?php }
				
				if(!empty($pinterest_url)){	?>
					<li>
						<a class="pinterest" href="<?php echo $pinterest_url; ?>" target="_blank"><?php _e('Pinterest', 'wellthemes'); ?></a>
					</li>
				<?php }
				
				if(!empty($dribbble_url)){	?>
					<li>
						<a class="dribbble" href="<?php echo $dribbble_url; ?>" target="_blank"><?php _e('Dribbble', 'wellthemes'); ?></a>
					</li>
				<?php }
										
				if(!empty($linkedin_url)){	?>
					<li class="linkedin">
						<a class="linkedin" href="<?php echo $linkedin_url; ?>" target="_blank"><?php _e('Linkedin', 'wellthemes'); ?></a>
					</li>
				<?php }
				
				if(!empty($instagram_url)){	?>
					<li>
						<a class="instagram" href="<?php echo $instagram_url; ?>" target="_blank"><?php _e('Instagram', 'wellthemes'); ?></a>
					</li>
				<?php }
				
				if(!empty($youtube_url)){	?>
					<li>
						<a class="youtube" href="<?php echo $youtube_url; ?>" target="_blank"><?php _e('Youtube', 'wellthemes'); ?></a>
					</li>
				<?php }
				
				if(!empty($rss_url)){	?>
					<li>
						<a class="rss" href="<?php echo $rss_url; ?>" target="_blank"><?php _e('RSS', 'wellthemes'); ?></a>
					</li>
				<?php }	 ?>
