...
<!-- MTB-Background-Single -->
<script type='text/javascript'>
GA_googleFillSlot("MTB-Background-Single");
</script>       

    <div id="content" class="col-full">
		<div id="main" class="col-left">
			 <div class="box">   
			<div class="post"><b>LIVE venerdì 13 aprile dalle 18:20 la diretta della seconda prova di coppa del mondo di XC da Houffalize, Belgio, con l'Eliminator! <a href="http://www.mtb-forum.it/live-worldcup-houffalize-xc-eliminator/">Clicca qui per saperne di più</a>.</b><br>
				<img src="http://www.mtb-forum.it/images/576.jpg">
				</div> </div>
