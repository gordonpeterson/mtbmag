<?php
/*
Template Name Posts: Freecaster 4x Poland
*/
?>
...
<div id="content" class="col-full">
	...
	<object width="640" height="360" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"><param name="movie" value="http://player.extreme.com/FCPlayer.swf?id=dj0xMDE5OTc2JmM9MTAwMDAwNg"/><param name="allowfullscreen" value="true" /><param name="allowscriptaccess" value="always" /><param name="wmode" value="transparent" /><embed src="http://player.extreme.com/FCPlayer.swf?id=dj0xMDE5OTc2JmM9MTAwMDAwNg" width="640" height="360" type="application/x-shockwave-flash" allowfullscreen="true" allowscriptaccess="always" wmode="transparent" /></object>
						</br></br>
						     <div class="entry">
		                        	<?php wp_link_pages(); ?>
									<?php the_content(); ?>	
						...
						<td style="width:300px; vertical-align:top; padding:0px 0px 0px 5px">
							...
							<script>(function(d, s, id) {
							  ...
							  fjs.parentNode.insertBefore(js, fjs);
								...
								<div class="fb-live-stream" data-event-app-id="116905355012808" data-width="300" data-height="600" data-always-post-to-friends="false"></div>
