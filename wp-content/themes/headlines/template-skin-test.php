...
GA_googleFillSlot("MTB-Background-Single");
    ...
    <div id="content-skin" class="col-full">
                    ...
                    <div class="post">
                        ...
                        <p class="post-meta">
							...
							<img src="<?php bloginfo('template_directory'); ?>/images/views.png" alt="" / valign="bottom"><?php		                    
														...
														?> in <?php the_category(', ') ?> <?php language_selector_flags(); ?>
		                    <?php edit_post_link( __('{ Edit }', 'woothemes'), '<span class="edit-post-link">', '</span>' ); ?> </p>
