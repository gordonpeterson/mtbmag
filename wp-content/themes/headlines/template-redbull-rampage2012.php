<?php
/*
Template Name Posts: Redbull Rampage 2012
*/
?>
            ...
            <?php $GLOBALS['saved_author'] = $authordata; // Save author data for sidebar widget ?>
                ...
                <div class="box">
                    <div class="post">
						...
						<td style="width:400px; vertical-align:top; padding:0px 0px 0px 5px">
							<span style="font-weight:bold; font-variant:small-caps">Facebook chat</span>
						
							<div id="responsecontainer" class="fb-comments" order_by="reverse_time" data-href="http://www.mtb-forum.it/live-redbull-rampage-2012/" data-num-posts="10" data-width="400" ></div>
								</br>
							<iframe src="http://www.facebook.com/plugins/comments.php?href=www.mtb-forum.it/rampage-2012-diretta-e-chat-room/&permalink=1" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:130px; height:16px;" allowTransparency="true"></iframe> 
						</td></tr>
						</table>
						</br></br>
