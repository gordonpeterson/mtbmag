<?php
/*
Template Name Posts: Colorado FR
*/
?>
                    ...
                    <div class="post">
						...
						<table style="width:100%;" border="0" cellpadding="0" cellspacing="0" >
							...
							<tr><td style="vertical-align:top">
								<script type="text/javascript" src="http://cdncon.vo.llnwd.net/o2/adrenaline_garage/cff/cff.js"></script>
								<iframe name="webcast" id="webcast" scrolling="none" width=640 height=403 src="" frameborder=0 ></iframe>
						</br></br>
						     <div class="entry">
		                        	<?php wp_link_pages(); ?>
									<?php the_content(); ?>	
						...
						<td style="width:300px; vertical-align:top; padding:0px 0px 0px 5px">
							...
							<script>(function(d, s, id) {
							  ...
							  fjs.parentNode.insertBefore(js, fjs);
								...
								<div class="fb-live-stream" data-event-app-id="116905355012808" data-width="300" data-via-url="http://www.mtb-forum.it/live-dh-worldcup-fort-william/" data-xid="Windham XC Men" data-height="800" data-always-post-to-friends="false"></div>
