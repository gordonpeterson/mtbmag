<?php
/*
Template Name Posts: Redbull TV Berg Line
*/
?>
                ...
                <div class="box">
                    <div class="post">
						...
						<table style="width:100%;" border="0" cellpadding="0" cellspacing="0" ><tr><td style="vertical-align:top">
							<!-- Start of Brightcove Player -->  <div style="display:none">  </div>  <!-- By use of this code snippet, I agree to the Brightcove Publisher T and C  found at https://accounts.brightcove.com/en/terms-and-conditions/.  -->  <script language="JavaScript" type="text/javascript" src="http://admin.brightcove.com/js/BrightcoveExperiences.js"></script>  <object id="myExperience1624736516001" class="BrightcoveExperience">   <param name="bgcolor" value="#FFFFFF" />   <param name="width" value="640" />   <param name="height" value="360" />   <param name="playerID" value="1398061561001" />   <param name="playerKey" value="AQ~~,AAAApYJ7UqE~,xqr_zXk0I-zzNndy8NlHogrCb5QdyZRf" />   <param name="isVid" value="true" />   <param name="isUI" value="true" />   <param name="dynamicStreaming" value="true" />      <param name="@videoPlayer" value="1624736516001" /> </object>  <!--  This script tag will cause the Brightcove Players defined above it to be created as soon as the line is read by the browser. If you wish to have the player instantiated only after the rest of the HTML is processed and the page load is complete, remove the line. --> <script type="text/javascript">brightcove.createExperiences();</script>  <!-- End of Brightcove Player -->
						</br></br>
						     <div class="entry">
		                        	<?php wp_link_pages(); ?>
									<?php the_content(); ?>	
						...
						<td style="width:300px; vertical-align:top; padding:0px 0px 0px 5px">
							...
							<script>(function(d, s, id) {
							  ...
							  js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=189864777739733";
							  fjs.parentNode.insertBefore(js, fjs);
							}(document, 'script', 'facebook-jssdk'));</script>								
	<div class="fb-live-stream" data-event-app-id="189864777739733" data-width="280" data-height="600" data-xid="RB Berg Line" data-via-url="http://www.mtb-forum.it/live-redbull-berg-line/" data-always-post-to-friends="false"></div>
