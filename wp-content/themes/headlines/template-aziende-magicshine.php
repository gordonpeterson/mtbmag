<?php
/*
Template Name: Sezione Magic Shine
*/
?>
<?php get_header(); ?>
		 ...
		 <tr>
		  ...
		  <td>
			<table style="" border="0" cellpadding="0" cellspacing="0" class="widget">
				<tr><td style="text-alignleft"><img src="http://www.mtb-forum.it/images/magic.jpg" <br><br></br>SYSMIC srl<br>
								Viale Spartaco Lavagnini 13
								<br>
				50129 Firenze (FI) <br>
				Tel. +39-055.5359739<br>
				info@magicshineitalia.it<br>
					<a href="http://www.magicshineitalia.it/">Magic Shine</a><br><br> </td></tr>
