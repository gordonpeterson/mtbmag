<?php
/*
Template Name Posts: Redbull Fontana
*/
?>
            ...
            <?php $GLOBALS['saved_author'] = $authordata; // Save author data for sidebar widget ?>
                ...
                <div class="box">
                    <div class="post">
						...
						<div style="display:none"></div><script language="JavaScript" type="text/javascript" src="http://admin.brightcove.com/js/BrightcoveExperiences.js"></script><script type="text/javascript" src="http://admin.brightcove.com/js/APIModules_all.js"></script><object id="myExperience1154759062001" class="BrightcoveExperience"><param name="isVid" value="true" /><param name="secureConnections" value="true" /><param name="width" value="940" /><param name="playerKey" value="AQ~~,AAAA1vDIGdk~,NR1bCsD6UB4vvTuHvJsbvNWSFKTbLqyP" /><param name="@videoPlayer" value="ref:1243320209393" /><param name="labels" value="http://www.redbull.com/cs/RedBull/brightcove/labels/it_IT_labels.xml" /><param name="playerID" value="1154759062001" /><param name="startTime" value="1361472572261" /><param name="linkBaseURL" value="http://www.redbull.it/cs/Satellite/it_IT/Video/Video-Marco-Aurelio-Fontana---Training-Session-021243320209393" /><param name="debuggerID" value="" /><param name="bgcolor" value="#000000" /><param name="dynamicStreaming" value="true" /><param name="autoStart" value="true" /><param name="isRTL" value="false" /><param name="flashID" value="myExperience1243320209393" /><param name="height" value="600" /><param name="isUI" value="true" /></object><script type="text/javascript">brightcove.createExperiences();</script>
						</br></br>
						     <div class="entry">
		                        	<?php wp_link_pages(); ?>
									<?php the_content(); ?>	
