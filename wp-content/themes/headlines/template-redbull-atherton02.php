<?php
/*
Template Name Posts: Redbull atherton 2/4
*/
?>
...
<div id="content" class="col-full">
	...
	<div style="display:none"></div><script language="JavaScript" type="text/javascript" src="http://admin.brightcove.com/js/BrightcoveExperiences.js"></script><script type="text/javascript" src="http://admin.brightcove.com/js/APIModules_all.js"></script><object id="myExperience1684512102001" class="BrightcoveExperience"><param name="link" value="http://www.redbull.com/en/bike" /><param name="playerKey" value="AQ~,AAABTw4lHzE,sr1E9bdX6d4wCdvdlD8QKdNij3uKs2K9" /><param name="socialHover" value="Share or embed" /><param name="isUI" value="true" /><param name="jumpHover" value="Jump backwards" /><param name="playerID" value="1684512102001" /><param name="@videoPlayer" value="ref:RBUK_FourByThree_EP2_Dirty_XDCAMHD422-fourbythree_spec-BikeChannelSpec.mp4" /><param name="flashID" value="myExperience1331577049304" /><param name="isRTL" value="false" /><param name="wmode" value="opaque" /><param name="linkBaseURL" value="http://www.redbull.com/en/bike/episodes/1331577057092/four-by-three-dan-atherton-s-enduro" /><param name="autoStart" value="true" /><param name="height" value="503" /><param name="isVid" value="true" /><param name="logoHover" value="Visit RedBull.com/Bike" /><param name="bgcolor" value="#000000" /><param name="htmlFallback" value="true" /><param name="width" value="895" /><param name="filter" value="channel:Bike" /><param name="onsite" value="false" /><param name="debuggerID" value="" /><param name="purl" value="http://www.redbull.com/en/bike/stories/1331577054547/four-by-three-dan-atherton-s-enduro" /><param name="dynamicStreaming" value="true" /><param name="startTime" value="1349421026086" /></object><script type="text/javascript">brightcove.createExperiences();</script>
						</br></br>
						     <div class="entry">
		                        	<?php wp_link_pages(); ?>
									<?php the_content(); ?>	
