<?php
/*
Template Name Posts: Redbull Rampage 2010
*/
?>
...
<div style="display:none"></div><script language="JavaScript" type="text/javascript" src="http://admin.brightcove.com/js/BrightcoveExperiences.js"></script><script type="text/javascript" src="http://admin.brightcove.com/js/APIModules_all.js"></script><object id="myExperience1154759062001" class="BrightcoveExperience"><param name="debuggerID" value="" /><param name="playerKey" value="AQ~~,AAAA1vDIGdk~,NR1bCsD6UB4vvTuHvJsbvNWSFKTbLqyP" /><param name="dynamicStreaming" value="true" /><param name="playerID" value="1154759062001" /><param name="purl" value="http://www.redbullusa.com/cs/Satellite/en_US/Video/red-bull-rampage-2010-dvd-021243259421088" /><param name="flashID" value="myExperience1243259421088" /><param name="isVid" value="true" /><param name="startTime" value="1348431532085" /><param name="@videoPlayer" value="ref:1243259421088" /><param name="linkBaseURL" value="http://www.redbullusa.com/cs/Satellite/en_US/Video/red-bull-rampage-2010-dvd-021243259421088" /><param name="isRTL" value="false" /><param name="height" value="349" /><param name="autoStart" value="true" /><param name="isUI" value="true" /><param name="labels" value="http://www.redbull.com/cs/RedBull/brightcove/labels/en_US_labels.xml" /><param name="bgcolor" value="#000000" /><param name="secureConnections" value="true" /><param name="width" value="620" /></object><script type="text/javascript">brightcove.createExperiences();</script>
						</br></br>
						     <div class="entry">
		                        	<?php wp_link_pages(); ?>
									<?php the_content(); ?>	
